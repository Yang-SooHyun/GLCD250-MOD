...
model_data = pd.read_parquet("data/output/4.6km_resolution_dataset/4.6km_resolution_dataset.parquet")
            ...
            for nl in num_encoder_layers:
                for lr in learning_rates:
                    for dr in dropout_rates:
                        ...
                        save_path = os.path.join(save_dir , f"bs{bs}_md{md}_nh{nh}_nl{nl}_lr{lr}_dr{dr}.pth")
                        torch.save({
