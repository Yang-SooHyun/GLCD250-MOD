...
# Load masking file
masking_file = pd.read_parquet("data/inventory/df_masking_total.parquet")
Hylak_ids = sorted(list(masking_file['Hylak_id'].unique()))

# Load scalers and columns_dict
with open("data/output/models/scalers.pkl", "rb") as f:
    _meta = pickle.load(f)
scalers = _meta["scalers"]
columns_dict = _meta.get("columns_dict")

# Load trained model
best_model_path = "data/output/models/best_model.pth"
...
application_dir = "data/output/250m_lake"
output_dir = "data/output/GLCD250-MOD"
